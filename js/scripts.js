...
// Stories Pagination -----------------
var numOfImgSlides = $('.story-image').length;
$('.totalMobileSlide').text( numOfImgSlides );

var numOfTotalSlides = $('.story-image-container').length;
var container = document.querySelector('.mobile-stories-container');

let slideWidth = $( "div.mobile-stories-container:first" ).width();

$('.currentMobileSlide').text('0');

container.addEventListener('scroll', function(e) {
  let slideLeft = $('.mobile-stories-container').scrollLeft();
  let currentNum = slideLeft/slideWidth;

  let currentNumWhole = (Math.round(currentNum));
  $('.currentMobileSlide').text( currentNumWhole );
});

$(window).on('resize', function() {
  let slideWidth = $( "div.mobile-stories-container:first" ).width();
  let viewportWidth = slideWidth*numOfTotalSlides
